...
a = 0
while a < 10:   
        plt.plot(matriz_N[a],matriz_dt[a])
        a+=1

b = 0
while b < 10:   
        plt.plot(matriz_N[b],matriz_mem[b])
        b+=1
...
#1)
ax[0].figure(1)
ax[0].ylabel("Tiempo transcurrido")
ax[0].title("Rendimiento A@B")
ax[0].xscale("log")
ax[0].yscale("log")
...
#2)
ax[1].figure(2)
ax[1].xlabel("Tamaño matriz N")
ax[1].ylabel("Uso memoria")
ax[1].xscale("log")
ax[1].yscale("log")
